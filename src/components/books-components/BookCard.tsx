          ...
          <div className="translate-y-4 transform transition-transform duration-300 group-hover:translate-y-0">
            <div className="flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm">
              <div className="flex justify-center gap-3 px-3 py-2 sm:gap-6 sm:px-4 sm:py-3">
                ...
                <BookOpen className="h-6 w-6 text-white transition-transform duration-300 group-hover:scale-110 sm:h-10 sm:w-10" />
              </div>
            </div>
          </div>
        </div>
    ...
    <Reveal>
      <div className={layoutClasses}>
        ...
        <div className="flex w-full flex-col items-center justify-center gap-5 px-2 sm:gap-7 sm:px-4 lg:w-1/2">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:gap-6">
            ...
            {hasFilmLink && filmLink && (
              <ButtonLink
                href={filmLink}
                className="group rounded-xl border-2 border-slate-900 bg-primary text-slate-900 hover:bg-slate-800 hover:text-white dark:text-white dark:hover:border-slate-50 dark:border-slate-300"
                {...(filmLink
        ...
        <div className="w-full flex-shrink-0 sm:w-3/4 md:w-2/3 lg:w-1/3">
          <PhotoMagazine link={galleryLink} src={coverImage} />
        </div>
      </div>
    </Reveal>
  );
