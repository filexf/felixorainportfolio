  ...
  return (
    <div className="flex w-full justify-center pt-[40px] pb-[120px]">
      <div className="flex w-4/5 flex-col gap-[40px]">
        ...
        <p className="body-font mx-auto max-w-4xl text-center mb-2">{text}</p>
          ...
          {images.map((image, index) => (
            ...
            >
              <img
                src={image.src}
                alt={image.title}
                className="absolute h-full w-full object-cover hover:scale-[0.97] transition-transform duration-200 cursor-pointer"
                loading="lazy"
              />
            </div>
          ))}
